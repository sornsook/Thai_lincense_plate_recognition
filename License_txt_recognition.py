...
file_name = 'thai3.jpg' # provide the name of image
...
### Function for for cleaning plate
...
def cleanAndRead(img, contours,file_name):
	for i,cnt in enumerate(contours):
		...
		if rect:
			...
			# cv2.waitKey(0)
			plt.imshow(img) # Show detected images
...
cleanAndRead(img, contours,file_name)